...
<head>
  ...
  <link rel="stylesheet" href="{{ Url('') }}/public/AdminLTE/bower_components/bootstrap/dist/css/bootstrap-rtl.min.css">
  <!-- Font Awesome -->
  ...
  <link rel="stylesheet" href="{{ Url('') }}/public/AdminLTE/dist/css/AdminLTE-rtl.css">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ Url('') }}/public/AdminLTE/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
