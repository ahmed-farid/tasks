...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">نسيت كلمة المرور</p>
    @if(session('success'))
    ...
    <form method="post">
      ...
      <div class="row">
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">إعادة تعيين</button>
        </div>
        <!-- /.col -->
      </div>
    </form>

    <a href="{{ url('admin/login') }}">تسجيل الدخول</a><br>
